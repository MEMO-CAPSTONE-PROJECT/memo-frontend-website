          ...
          <MemoCard>
            <section className="flex flex-col items-center space-y-xl">
              ...
              <div className='flex flex-col items-center pb-2'>
                <p className="text-body-1 text-header font-bold">ยืนยันรหัส OTP</p>
                <p className="text-body-2 text-body font-regular">กรุณาตรวจสอบรหัสจากอีเมลของท่าน</p>
              </div>
            </section>
            <form className="flex flex-col space-y-lg">
              ...
              <div className='justify-items-stretch flex gap-56 pt-4'>
                ...
                <Link href="/admin/password"><p className='text-title-1 underline text-[14px] justify-self-end'>ส่งอีกครั้ง</p></Link>
              </div>
