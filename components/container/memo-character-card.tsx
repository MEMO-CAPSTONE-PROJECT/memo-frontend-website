...
export default function MemoCharacterCard({ title, children, size = "medium", onClick }: Readonly<MemoCharacterCardProps>) {
    ...
    return (
        <button className="group rounded-md overflow-clip" onClick={onClick}>
            <div className={`
                        relative flex flex-col items-center justify-center border-sm rounded-md text-body-1 border-system-gray space-y-lg px-3xl py-lg 
