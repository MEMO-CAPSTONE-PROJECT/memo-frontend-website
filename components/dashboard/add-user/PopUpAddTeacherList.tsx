...
const teacherSchema = z
  .object({
    ...
    class: z
      .object({
        level: z.string().min(1, "กรุณากรอกชั้นเรียน").regex(/^[1-4]$/, "ชั้นเรียนต้องเป็นตัวเลขจาก 1 ถึง 4"),
        room: z.string().min(1, "กรุณากรอกห้องเรียน").regex(/^[1-6]$/, "ห้องเรียนต้องเป็นตัวเลขจาก 1 ถึง 6"),
      })
      .optional() 
      .nullable(),
    email: z
